...
void defiNet::changeInstance(const char* instance, int index) {
  ...
  if ((index < 0) || (index > numPins_)) {
     snprintf (errMsg, 256, "ERROR (DEFPARS-6083): The index number %d specified for the NET INSTANCE is invalid.\nValid index is from 0 to %d. Specify a valid index number and then try again.",
             index, numPins_);
...
void defiNet::changePin(const char* pin, int index) {
  ...
  if ((index < 0) || (index > numPins_)) {
     snprintf (errMsg, 256, "ERROR (DEFPARS-6084): The index number %d specified for the NET PIN is invalid.\nValid index is from 0 to %d. Specify a valid index number and then try again.",
             index, numPins_);
...
const char* defiNet::polygonName(int index) const {
  ...
  if (index < 0 || index > numPolys_) {
     snprintf (errMsg, 256, "ERROR (DEFPARS-6085): The index number %d specified for the NET POLYGON is invalid.\nValid index is from 0 to %d. Specify a valid index number and then try again.",
             index, numPolys_);
...
const char* defiNet::rectName(int index) const {
  ...
  if (index < 0 || index > numRects_) {
     snprintf (errMsg, 256, "ERROR (DEFPARS-6086): The index number %d specified for the NET RECTANGLE is invalid.\nValid index is from 0 to %d. Specify a valid index number and then try again.",
             index, numRects_);
