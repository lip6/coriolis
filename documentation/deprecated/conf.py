# -*- coding: utf-8 -*-
#
# Coriolis documentation build configuration file, created by
...
project = u'Coriolis'
copyright = u'2000-2019, Sorbonne Université'
...
latex_documents = [
  ('index', 'Coriolis.tex', u'Coriolis Documentation', u'UPMC', 'manual'),
]
...
man_pages = [
    ('index', 'coriolis', u'Coriolis Documentation', [u'UPMC'], 1)
]
...
texinfo_documents = [
  ('index', 'Coriolis', u'Coriolis Documentation',
   u'UPMC/LIP6/SoC', 'Coriolis', 'One line description of project.',
   'Miscellaneous'),
]
