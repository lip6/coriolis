...
#define   METHOD_HEAD(function)    GENERIC_METHOD_HEAD(MeltemiEngine,meltemi,function)
...
// +=================================================================+
  ...
  static PyObject* PyMeltemiEngine_get ( PyObject*, PyObject* args )
  {
    ...
    return PyEtesianEngine_Link(meltemi);
  }
  ...
  static PyObject* PyMeltemiEngine_create ( PyObject*, PyObject* args )
  {
    ...
    if (meltemi == NULL) {
      ...
      cerr << Warning("%s already has a Meltemi engine.",getString(cell).c_str()) << endl;
    HCATCH
...
// +=================================================================+
  ...
  PyTypeInheritedObjectDefinitions(MeltemiEngine,PyToolEngine)
