...
namespace Meltemi {
  ...
  {                "get",                 (PyCFunction)PyMeltemiEngine_get, METH_VARARGS | METH_STATIC,                       "Returns the Meltemi engine attached to the Cell, None if there isn't."},
  {             "create",              (PyCFunction)PyMeltemiEngine_create, METH_VARARGS | METH_STATIC,                                                      "Create an Meltemi engine on this cell."},
  {            "exclude",             (PyCFunction)PyMeltemiEngine_exclude,               METH_VARARGS,                                                "Add the specified net to the exclusion list."},
  {   "getFixedAbHeight",    (PyCFunction)PyMeltemiEngine_getFixedAbHeight,                METH_NOARGS,                                                     "Returns the forced abutment box height."},
  {    "getFixedAbWidth",     (PyCFunction)PyMeltemiEngine_getFixedAbWidth,                METH_NOARGS,                                                      "Returns the forced abutment box width."},
  {          "setViewer",           (PyCFunction)PyMeltemiEngine_setViewer,               METH_VARARGS,                                                   "Associate a Viewer to this MeltemiEngine."},
  {        "selectBloat",         (PyCFunction)PyMeltemiEngine_selectBloat,               METH_VARARGS,                                                           "Select the Cell bloating profile."},
  {           "setBlock",            (PyCFunction)PyMeltemiEngine_setBlock,               METH_VARARGS,                                                      "Set the sub-block (Instance) to place."},
  {       "setPlaceArea",        (PyCFunction)PyMeltemiEngine_setPlaceArea,               METH_VARARGS,                                                 "Set the sub-area into wich place the cells."},
  {       "setDefaultAb",        (PyCFunction)PyMeltemiEngine_setDefaultAb,                METH_NOARGS,               "Compute and set the abutment box using the aspect ratio and the space margin."},
  {   "setFixedAbHeight",    (PyCFunction)PyMeltemiEngine_setFixedAbHeight,               METH_VARARGS, "Use this height when computing the size of the default abutment box (disable aspect ratio)."},
  {    "setFixedAbWidth",     (PyCFunction)PyMeltemiEngine_setFixedAbWidth,               METH_VARARGS,  "Use this width when computing the size of the default abutment box (disable aspect ratio)."},
  {     "setSpaceMargin",      (PyCFunction)PyMeltemiEngine_setSpaceMargin,               METH_VARARGS,                                    "Override the configuration space margin parameter value."},
  {"setDensityVariation", (PyCFunction)PyMeltemiEngine_setDensityVariation,               METH_VARARGS,                               "Override the configuration density variation parameter value."},
  {     "setAspectRatio",      (PyCFunction)PyMeltemiEngine_setAspectRatio,               METH_VARARGS,                                    "Override the configuration aspect ratio parameter value."},
  {     "resetPlacement",      (PyCFunction)PyMeltemiEngine_resetPlacement,                METH_NOARGS,               "Compute and set the abutment box using the aspect ratio and the space margin."},
  {    "clearColoquinte",     (PyCFunction)PyMeltemiEngine_clearColoquinte,                METH_NOARGS,                                         "De-allocate the Coloquinte related data structures."},
  {              "place",               (PyCFunction)PyMeltemiEngine_place,                METH_NOARGS,                                                                   "Run the placer (Meltemi)."},
  {       "flattenPower",        (PyCFunction)PyMeltemiEngine_flattenPower,                METH_NOARGS,                                "Build abstract interface in top cell for supply & blockages."},
  {             "doHFNS",              (PyCFunction)PyMeltemiEngine_doHFNS,                METH_NOARGS,                                                      "Perform the high fanout net synthesis."},
  {      "addTrackAvoid",       (PyCFunction)PyMeltemiEngine_addTrackAvoid,               METH_VARARGS,                            "Mark a vertical track under which no terminal should be present."},
  {        "toHurricane",         (PyCFunction)PyMeltemiEngine_toHurricane,                METH_NOARGS,                                  "Build the Hurricane post-placement manipulation structure."},
  {            "destroy",             (PyCFunction)PyMeltemiEngine_destroy,                METH_NOARGS,                         "Destroy the associated hurricane object. The python object remains."},
