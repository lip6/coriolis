...
class CachedParameter ( object ):
    ...
    def cacheWrite ( self ):
        ...
        if   p.type == Cfg.Parameter.Type.Enumerate:  p.setInt      ( int  (self.v) )
        elif p.type == Cfg.Parameter.Type.Int:        p.setInt      ( int  (self.v) )
        elif p.type == Cfg.Parameter.Type.Bool:       p.setBool     ( bool (self.v) )
        elif p.type == Cfg.Parameter.Type.Double:     p.setDouble   ( float(self.v) )
