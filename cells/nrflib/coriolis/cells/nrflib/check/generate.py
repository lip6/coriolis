...
if __name__ == '__main__':
  ...
  if not modelName:
    print '[ERROR] Missing mandatory argument <modelName>.'
    sys.exit( 1 )
 
  if modelName.startswith( 'rf1dr0' ):
    cell = stratus.buildModel( 'dpgen_RF1'
                             , stratus.DoNetlist|stratus.DoLayout
                             , className ='DpgenRf1dr0'
                             , modelName = modelName
  ...
  if modelName.startswith( 'rf1r0' ):
    cell = stratus.buildModel( 'dpgen_RF1'
                             , stratus.DoNetlist|stratus.DoLayout
                             , className ='DpgenRf1r0'
                             , modelName = modelName
                             , parameters={ 'nbit'     : options.bits
                                          , 'nword'    : options.words
                                          , 'logical'  : True
  ...
  elif modelName.startswith( 'rf1d' ):
    cell = stratus.buildModel( 'dpgen_RF1'
                             , stratus.DoNetlist|stratus.DoLayout
                             , className ='DpgenRf1d'
                             , modelName = modelName
  ...
  elif modelName.startswith( 'fifo' ):
    cell = stratus.buildModel( 'dpgen_RF1'
                             , stratus.DoNetlist|stratus.DoLayout
                             , className ='DpgenFifo'
                             , modelName = modelName
    ...
    print '[ERROR] Unsupported <modelName> value: "%s".' % modelName
    sys.exit( 1 )
