...
def _setup_techno ( coriolisTechDir ):
    ShellEnv.RDS_TECHNO_NAME   = (coriolisTechDir / 'scmos2m1u_nsx2' / 'scmos2m1u.rds').as_posix()
    ShellEnv.GRAAL_TECHNO_NAME = (coriolisTechDir / 'scmos2m1u_nsx2' / 'symbolic.graal' ).as_posix()
    ShellEnv.DREAL_TECHNO_NAME = (coriolisTechDir / 'scmos2m1u_nsx2' / 'symbolic.dreal' ).as_posix()

    db = DataBase.getDB()
    CRL.System.get()

    tech = Technology.create(db, 'scmos2m1u_nsx2')
