...
def _setup_techno ( coriolisTechDir ):
    ShellEnv.RDS_TECHNO_NAME   = (coriolisTechDir / 'sky130_lsx' / 'sky130_lsx.rds').as_posix()
    ShellEnv.GRAAL_TECHNO_NAME = (coriolisTechDir / 'sky130_lsx' / 'symbolic.graal' ).as_posix()
    ShellEnv.DREAL_TECHNO_NAME = (coriolisTechDir / 'sky130_lsx' / 'symbolic.dreal' ).as_posix()

    db = DataBase.getDB()
    CRL.System.get()

    tech = Technology.create(db, 'Sky130_lsx')
