...
def setup ():
   ...
   #tech.addLayerAlias( 'poly'    ,  'poly'      )
    ...
    tech.addLayerAlias( 'li.block', 'blockage1'  )
    tech.addLayerAlias( 'm1.block', 'blockage2'  )
    tech.addLayerAlias( 'm2.block', 'blockage3'  )
    tech.addLayerAlias( 'm3.block', 'blockage4'  )
    tech.addLayerAlias( 'm4.block', 'blockage5'  )
    tech.addLayerAlias( 'm5.block', 'blockage6'  )
   ...
   #PWELL.setExtentionCap( pWell, l(0.0) )
    ...
    NTIE.setMinimalSize   (           l(1.5) )
    NTIE.setExtentionCap  ( nWell   , l(0.75) )
    NTIE.setExtentionWidth( nWell   , l(0.25) )
    NTIE.setExtentionCap  ( nImplant, l(0.5) )
    NTIE.setExtentionWidth( nImplant, l(0.25) )
    NTIE.setExtentionCap  ( active  , l(0.25) )
    NTIE.setExtentionWidth( active  , l(0.0) )
    
    PTIE.setMinimalSize   (           l(1.5) )
    PTIE.setExtentionCap  ( nWell   , l(0.75) )
    PTIE.setExtentionWidth( nWell   , l(0.25) )
    PTIE.setExtentionCap  ( nImplant, l(0.5) )
    PTIE.setExtentionWidth( nImplant, l(0.25) )
    PTIE.setExtentionCap  ( active  , l(0.25) )
    PTIE.setExtentionWidth( active  , l(0.0) )
    
    NDIF.setMinimalSize   (           l(1.5) )
    NDIF.setExtentionCap  ( nImplant, l(0.5) )
    NDIF.setExtentionWidth( nImplant, l(0.25) )
    NDIF.setExtentionCap  ( active  , l(0.25) )
    NDIF.setExtentionWidth( active  , l(0.0) )
    
    PDIF.setMinimalSize   (           l(1.5) )
    PDIF.setExtentionCap  ( pImplant, l(0.5) )
    PDIF.setExtentionWidth( pImplant, l(0.25) )
    PDIF.setExtentionCap  ( active  , l(0.25) )
    PDIF.setExtentionWidth( active  , l(0.0) )
    
    GATE.setMinimalSize   (           l(0.5) )
    GATE.setExtentionCap  ( poly    , l(0.75) )
    ...
    PTRANS.setMinimalSize   (           l( 0.5) )
    PTRANS.setExtentionCap  ( nWell   , l(-0.5) )
    PTRANS.setExtentionWidth( nWell   , l( 2.25) )
    PTRANS.setExtentionCap  ( pImplant, l(-0.5) )
    PTRANS.setExtentionWidth( pImplant, l( 2.0) )
    PTRANS.setExtentionCap  ( active  , l(-0.75) )
    PTRANS.setExtentionWidth( active  , l( 1.5) )
    
    POLY .setMinimalSize   (           l(0.5) )
    POLY .setExtentionCap  ( poly    , l(0.25) )
    #POLY2.setMinimalSize   (           l(1.0) )
    #POLY2.setExtentionCap  ( poly    , l(0.5) )
    
    METAL1 .setMinimalSize   (           l(0.5) )
    METAL1 .setExtentionCap  ( metal1  , l(0.25) )
    METAL2 .setMinimalSize   (           l(0.5) )
    METAL2 .setExtentionCap  ( metal2  , l(0.5) )
    METAL3 .setMinimalSize   (           l(0.5) )
    METAL3 .setExtentionCap  ( metal3  , l(0.5) )
    METAL4 .setMinimalSize   (           l(0.5) )
    METAL4 .setExtentionCap  ( metal4  , l(0.5) )
    METAL4 .setMinimalSpacing(           l(1.5) )
    METAL5 .setMinimalSize   (           l(1.0) )
    METAL5 .setExtentionCap  ( metal5  , l(0.5) )
    ...
    CONT_BODY_N.setMinimalSize(           l( 0.5) )
    CONT_BODY_N.setEnclosure  ( nWell   , l( 0.75), Layer.EnclosureH|Layer.EnclosureV )
    CONT_BODY_N.setEnclosure  ( nImplant, l( 0.75), Layer.EnclosureH|Layer.EnclosureV )
    CONT_BODY_N.setEnclosure  ( active  , l( 0.5), Layer.EnclosureH|Layer.EnclosureV )
    CONT_BODY_N.setEnclosure  ( metal1  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    
    CONT_BODY_P.setMinimalSize(           l( 0.5) )
    #CONT_BODY_P.setEnclosure  ( pWell   , l( 1.5), Layer.EnclosureH|Layer.EnclosureV )
    CONT_BODY_P.setEnclosure  ( pImplant, l( 0.75), Layer.EnclosureH|Layer.EnclosureV )
    CONT_BODY_P.setEnclosure  ( active  , l( 0.5), Layer.EnclosureH|Layer.EnclosureV )
    CONT_BODY_P.setEnclosure  ( metal1  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    
    CONT_DIF_N.setMinimalSize(           l( 0.5) )
    CONT_DIF_N.setEnclosure  ( nImplant, l( 0.5), Layer.EnclosureH|Layer.EnclosureV )
    CONT_DIF_N.setEnclosure  ( active  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    CONT_DIF_N.setEnclosure  ( metal1  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    
    CONT_DIF_P.setMinimalSize(           l( 0.5) )
    CONT_DIF_P.setEnclosure  ( pImplant, l( 0.5), Layer.EnclosureH|Layer.EnclosureV )
    CONT_DIF_P.setEnclosure  ( active  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    CONT_DIF_P.setEnclosure  ( metal1  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    
    CONT_POLY.setMinimalSize(           l( 0.5) )
    CONT_POLY.setEnclosure  ( poly    , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    CONT_POLY.setEnclosure  ( metal1  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    
    # VIAs (i.e. Metal <--> Metal) (symbolic).
    VIA12 .setMinimalSize   (           l( 0.5) )
    VIA12 .setEnclosure     ( metal1  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA12 .setEnclosure     ( metal2  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA12 .setMinimalSpacing(           l( 2.0) )
    VIA23 .setMinimalSize   (           l( 0.5) )
    VIA23 .setEnclosure     ( metal2  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA23 .setEnclosure     ( metal3  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA23 .setMinimalSpacing(           l( 2.0) )
    VIA34 .setMinimalSize   (           l( 0.5) )
    VIA34 .setEnclosure     ( metal3  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA34 .setEnclosure     ( metal4  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA34 .setMinimalSpacing(           l( 2.0) )
    VIA45 .setMinimalSize   (           l( 0.5) )
    VIA45 .setEnclosure     ( metal4  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA45 .setEnclosure     ( metal5  , l( 0.25), Layer.EnclosureH|Layer.EnclosureV )
    VIA45 .setMinimalSpacing(           l( 2.0) )
    ...
    # Blockages (symbolic).
    BLOCKAGE1 .setMinimalSize (             l( 0.5) )
    BLOCKAGE1 .setExtentionCap( blockage1 , l( 0.25) )
    BLOCKAGE2 .setMinimalSize (             l( 1.0) )
    BLOCKAGE2 .setExtentionCap( blockage2 , l( 0.25) )
    BLOCKAGE3 .setMinimalSize (             l( 1.0) )
    BLOCKAGE3 .setExtentionCap( blockage3 , l( 0.25) )
    BLOCKAGE4 .setMinimalSize (             l( 1.0) )
    BLOCKAGE4 .setExtentionCap( blockage4 , l( 0.25) )
    BLOCKAGE5 .setMinimalSize (             l( 1.0) )
    BLOCKAGE5 .setExtentionCap( blockage5 , l( 0.5) )
