\begin{itemize}
    \item Name : DpgenNor4 -- Nor4 Macro-Generator
    \item Description : Generates a \verb-n- bits four inputs NOR with an output power of \verb-drive- named \verb-modelname-.
    \begin{itemize}
