\begin{itemize}
    \item Name : DpgenOr3 -- Or3 Macro-Generator
    \item Description : Generates a \verb-n- bits three inputs OR with an output power of \verb-drive- named \verb-modelname-.
    \begin{itemize}
