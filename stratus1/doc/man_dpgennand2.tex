\begin{itemize}
    \item Name : DpgenNand2 -- Nand2 Macro-Generator
    \item Description : Generates a \verb-n- bits two inputs NAND with an output power of \verb-drive- named \verb-modelname-.
    \begin{itemize}
