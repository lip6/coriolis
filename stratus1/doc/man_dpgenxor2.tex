\begin{itemize}
    \item Name : DpgenXor2 -- Xor2 Macro-Generator
    \item Description : Generates a \verb-n- bits two inputs XOR with an output power of \verb-drive- named \verb-modelname-.
    \begin{itemize}
