\begin{itemize}
    \item Name : DpgenNor2 -- Nor2 Macro-Generator
    \item Description : Generates a \verb-n- bits two inputs NOR with an output power of \verb-drive- named \verb-modelname-.
    \begin{itemize}
