\begin{itemize}
    \item Name : DpgenNand3 -- Nand3 Macro-Generator
    \item Description : Generates a \verb-n- bits three inputs NAND with an output power of \verb-drive- named \verb-modelname-.
    \begin{itemize}
