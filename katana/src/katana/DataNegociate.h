...
// Class  :  "DataNegociate".
  ...
  class DataNegociate {
    ...
    public:
                                         ...
                                         ~DataNegociate          ();
      inline bool                         isHighlyRipedUp        () const;
...
// Inline Functions.
  inline bool                         DataNegociate::isHighlyRipedUp        () const { return ((_ripupCount > 8) and (_ripupCount < 14)); }
  ...
  inline void                         DataNegociate::resetPerpandicularFree () { _perpandicularFree = Interval(false); }
