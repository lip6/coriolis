...
// | =============================================================== |
// |  C++ Header  :  "./katana/TrackBlockage.h"                      |
// +-----------------------------------------------------------------+
...
// Class  :  "TrackBlockage".
  ...
  class TrackBlockage : public TrackElement {
    public:
      static  TrackElement*  create                 ( Katana::Track*, Box );
    public:                                         
    ...
    private:
                                 TrackBlockage ( const TrackBlockage& ) = delete;
              TrackBlockage& operator=         ( const TrackBlockage& ) = delete;
  };
...
INSPECTOR_P_SUPPORT(Katana::TrackBlockage);
