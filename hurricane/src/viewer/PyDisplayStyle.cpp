...
// +=================================================================+
  ...
  {
    trace << "PyDisplayStyle_getDarkening()" << endl;
  ...
  {
    trace << "PyDisplayStyle_getGroup()" << endl;
  ...
  {
    trace << "PyDisplayStyle_getPattern()" << endl;
  ...
  {
    trace << "PyDisplayStyle_getThreshold()" << endl;
  ...
  {
    trace << "PyDisplayStyle_find()" << endl;
  ...
  {
    trace << "PyDisplayStyle_setDescription()" << endl;
  ...
  {
    trace << "PyDisplayStyle_setDarkening()" << endl;
  ...
  {
    trace << "PyDisplayStyle_inheritFrom()" << endl;
  ...
  {
    trace << "PyDisplayStyle_addDrawingStyle()" << endl;
