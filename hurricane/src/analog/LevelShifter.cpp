...
namespace Analog {
  ...
  const Name LevelShifter::_lsBulkConnectedName   ("LevelShifterBulkConnected");
  const Name LevelShifter::_lsBulkUnconnectedName ("LevelShifterBulkUnconnected");
  

  LevelShifter::LevelShifter ( Library* library, const Name& name, const Type& type )
    : Super(library,name,type)
  { }
  
  
  LevelShifter* LevelShifter::create ( Library* library
                                     , const Name& name
                                     , const Type& type
                                     , bool bulkConnected )
  {
    Name deviceName = (bulkConnected) ?  _lsBulkConnectedName :  _lsBulkUnconnectedName;
  ...
  void  LevelShifter::createConnections ( bool bulkConnected )
  {
  ...
  Name  LevelShifter::getDeviceName () const
