...
Instead of creating one more ad-\/hoc format, we just dump the \hyperlink{classHurricane_1_1DataBase}{Data\+Base} objects in a mirror like way in J\+S\+ON format.
...
\begin{DoxyItemize}
\item The stack of attributes translateds, but not consumeds by the parser and the objects currently openeds (that is, which parsing is not completed). This stack contains P\+OD or \hyperlink{namespaceHurricane}{Hurricane} objects (value or pointer). It is a vector of pair {\ttfamily }(key,value) where the {\itshape key} is either the attribute name ({\ttfamily \+\_\+bounding\+Box}, {\ttfamily \+\_\+x\+Min}, {\ttfamily \+\_\+master\+Cell}, ...) or the class name ({\ttfamily }.\hyperlink{classHurricane_1_1Net}{Net}, {\ttfamily }.\hyperlink{classHurricane_1_1Cell}{Cell}, ...).
\item The stack of J\+S\+ON objects currently openeds, thoses objects are all derived classes of \hyperlink{classHurricane_1_1JsonObject}{Json\+Object}.
