...
\begin{DoxyItemize}
\item {\bfseries Determinism checking.} The trace level to get only determinism related log is {\ttfamily 500}. Each line for the determinism is prepended with 'Deter$|$', possible with some leading spaces.
...
\begin{DoxyItemize}
\item Suppress the lookup table of {\bf Hurricane\-::\-Segment} toward \hyperlink{classKite_1_1TrackSegment}{Track\-Segment}. Instead uses the Observer mecanism between {\bf Katabatic\-::\-Auto\-Segment} and \hyperlink{classKite_1_1TrackSegment}{Track\-Segment}.
